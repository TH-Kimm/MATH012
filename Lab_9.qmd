...
2. The average teacher's salary in New Jersey is \$52,174, assuming a normal distribution with a standard deviation of \$7,500.
i. What is the probability that a randomly selected teacher makes less than \$50,000 per year?
```{webr-r}

```
ii. If we sample 100 teachers' salaries, what is the probability that the sample mean is less than \$50,000 per year?
```{webr-r}
